...
export const DiscoverScreen = () => {
  ...
  if (cards.length === 0) {
    return (
      <div className="flex-1 flex flex-col bg-[#0a0a0a] overflow-hidden">
        <div className="w-full max-w-2xl mx-auto flex-1 flex flex-col items-center justify-center text-center p-6">
  ...
  return (
    <div className="flex-1 flex flex-col relative bg-[#0a0a0a] overflow-hidden">
      <div className="w-full max-w-2xl mx-auto flex-1 flex flex-col relative">
